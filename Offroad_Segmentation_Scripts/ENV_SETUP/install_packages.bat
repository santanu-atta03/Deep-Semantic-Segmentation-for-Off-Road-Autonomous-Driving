...
IF "%CONDA_PREFIX%"=="" (
    ...
    IF EXIST "%UserProfile%\miniconda3\condabin\conda.bat" (
        ...
        call "C:\ProgramData\anaconda3\condabin\conda.bat" activate EDU
    ) ELSE (
...
conda install -c pytorch -c nvidia -c conda-forge pytorch torchvision torchaudio pytorch-cuda=11.8 ultralytics matplotlib -y && pip install segmentation-models-pytorch albumentations opencv-contrib-python tqdm
